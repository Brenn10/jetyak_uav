...
class util {
public:
  static constexpr long double C_PI =
      3.14159265358979323846; // My long PI value
   ...
   */
  static void rpy_from_quat(const geometry_msgs::Quaternion &pose,
   ...
   */
  template <typename T> static T clip(T x, T low, T high);
   ...
   */
  static void rotate_vector(double x, double y, double theta, double &xp,
                            double &yp);
   ...
   */
  static void inverse_pose(const geometry_msgs::Pose &in,
