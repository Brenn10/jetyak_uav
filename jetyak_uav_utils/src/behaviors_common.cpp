...
void Behaviors::createPID(bsc_common::pose4d_t &kp, bsc_common::pose4d_t &ki,
...
void Behaviors::downloadParams(std::string ns_param) {
  ...
  if (ns_param.length() == 0 or ns_param.back() == '/' or
      ns_param.compare("~") == 0)
    ns = ns_param;
  ...
  ros::param::param<double>(ns + "return_tagLossThresh", return_.tagLossThresh,
                            5);
